...
def compute_Score(TRAIN_FEATURES,TRAIN_LABELS,TEST_FEATURES,KFOLD_SPLITS,KFOLD_REPEATS,starttime,verbose=1):
    ...
    ENreg = ElasticNet(random_state=1234,max_iter=10e5,tol=5e-4)
...
ALPHAS=[0.01,0.02,0.05,0.1,1,10,20,25,50,75,100]
...
for strat in importfiles:
    ...
    [labels_predict_pd,this_gscv_results]=compute_Score(FILE_FEATURES,FILE_LABELS,TEST_FEATURES,KFOLD_SPLITS,KFOLD_REPEATS,time_start_overall,0)
